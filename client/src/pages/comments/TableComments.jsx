...
import RowsComments from './RowsComments'

export default function TableComments({data, tableHead, deleteData}) {
  return (
    ...
    style={{width: '90%'}}>
      ...
      <tbody>
        {data.length ? (
          data.map((el, index) => <RowsComments key={index} noRow={index} deleteP={deleteData} element={el} />)
        ) : (
          <tr>
