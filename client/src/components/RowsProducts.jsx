...
export default function RowsProducts({element}) {
  ...
  return (
    ...
    className='transition-all cursor-pointer hover:bg-slate-200'>
        ...
        <td className='text-left'>
            <button className='p-1 text-green-700 cursor-pointer transition-all hover:text-green-600'><i className="fas fa-edit"></i></button>
            <button className='p-1 text-red-700 cursor-pointer transition-all hover:text-red-600'><i className="fas fa-trash"></i></button>
