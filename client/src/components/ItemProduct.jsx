...
export default function ItemProduct({ data }) {
  ...
  return (
    <div className="flex justify-start gap-2 mt-2 border-b w-1/2" data-aos="zoom-in-up">
     ...
     <div>
      ...
      <div className="w-auto">
        ...
        <p className="text-xs text-gray-600 font-semibold">Unidades disponibles: {Unidades}</p>
        <span className="p-1 text-center mt-2 border rounded-xl block text-xs text-red-500" style={{
            width: '40%'
        }}>{Categoria}</span>
      </div>
     </div>
